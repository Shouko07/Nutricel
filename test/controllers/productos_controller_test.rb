...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { fecha_expiracion: @producto.fecha_expiracion, id_producto: @producto.id_producto, imagen: @producto.imagen, nombre: @producto.nombre, peso: @producto.peso, precio: @producto.precio } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { fecha_expiracion: @producto.fecha_expiracion, id_producto: @producto.id_producto, imagen: @producto.imagen, nombre: @producto.nombre, peso: @producto.peso, precio: @producto.precio } }
